...
import { ModalLayanan } from "../modal/modal-container";
		...
		<>
			<ModalLayanan isOpenModal={isOpen} onClose={() => setIsOpen(false)}>
				<ModalContent>
                  ...
                  as={Link}
									target="_self"
									href={`/app-module/pegawai/peremajaan/${encrypt(
										row.nip,
										"bkpsdm"
									)}`}
                  ...
                  as={Link}
									target="_self"
									href={`/app-module/pegawai/kgb/${encrypt(row.nip, "bkpsdm")}`}
                  ...
                  as={Link}
									target="_self"
									href={`/app-module/pegawai/tpp/${encrypt(row.nip, "bkpsdm")}`}
