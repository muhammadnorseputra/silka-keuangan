...
export const AlertDanger = ({ title, message = "", children = null }) => {
  return (
    <div
      role="alert"
      className="w-full p-4 border-red-500 rounded border-s-4 bg-red-50">
...
export const AlertWarning = ({ title, message = null, children = null }) => {
  return (
    <div
      role="alert"
      className="w-full p-4 rounded border-s-4 border-amber-500 bg-amber-50">
...
export const AlertInfo = ({ title, message = "", childre = "" }) => {
  return (
    <div
      role="alert"
      className="w-full p-4 bg-blue-100 border-blue-500 rounded border-s-4">
...
export const AlertSuccess = ({ title, message = "", children = "" }) => {
  return (
    <div
      role="alert"
      className="w-full p-4 bg-green-100 border-green-500 rounded border-s-4">
