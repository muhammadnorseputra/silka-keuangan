  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden ">
      <div className="text-center">
        ...
        <h1 className="mt-8 text-lg font-extrabold text-black/70">
          SILKA <span className="text-black/50">INEXIS</span>
        </h1>

        <p className="mt-4 text-lg text-black/60">BKPSDM KAB. BALANGAN</p>
